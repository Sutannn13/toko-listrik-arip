        ...
        <div data-auth-grid class="grid w-full items-stretch gap-6 lg:grid-cols-[1.12fr,0.88fr] lg:gap-10">
            ...
            <section class="w-full max-w-md place-self-center">
                ...
                <div data-auth-card
                    ...
                    <form method="POST" action="{{ route('password.store') }}" class="mt-6 space-y-5" data-ui-form
                        data-auth-form>
                        @csrf
                        ...
                        <div>
                            <label for="password" class="mb-1.5 block text-sm font-semibold text-slate-700">Password
                                Baru</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="password_confirmation"
                                class="mb-1.5 block text-sm font-semibold text-slate-700">Konfirmasi Password
                                Baru</label>
                            <div class="relative">

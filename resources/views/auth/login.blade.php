        ...
        <div data-auth-grid class="grid w-full items-stretch gap-6 lg:grid-cols-[1.12fr,0.88fr] lg:gap-10">
            <section
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="rounded-2xl border border-white/30 bg-white/18 p-4">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-100">Checkout Kilat</p>
                        <p class="mt-2 text-sm text-white">Alamat tersimpan otomatis, proses pembayaran lebih cepat.</p>
                    </div>
                    <div class="rounded-2xl border border-white/30 bg-white/18 p-4">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-100">Tracking Real-time
                        </p>
                        <p class="mt-2 text-sm text-white">Status order selalu ter-update tanpa harus tanya manual.</p>
                    </div>
                    <div class="rounded-2xl border border-white/30 bg-white/18 p-4">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-100">Garansi Digital</p>
                        <p class="mt-2 text-sm text-white">Klaim garansi tercatat dan mudah dipantau kapan saja.</p>
                    </div>
                    <div class="rounded-2xl border border-white/30 bg-white/18 p-4">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-100">Akun Aman</p>
            ...
            <section class="w-full max-w-md place-self-center">
                ...
                <div data-auth-card
                    ...
                    <div>
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-sky-700">Masuk</p>
                        <h2 data-auth-title class="mt-2 text-[1.9rem] font-extrabold leading-tight text-slate-900">
                            Selamat datang kembali</h2>
                        <p data-auth-subtitle class="mt-2 text-sm leading-relaxed text-slate-600">Silakan login untuk
                        ...
                        <div class="flex items-center justify-between gap-3 text-sm">
                            <label for="remember_me"
                                ...
                                <input id="remember_me" type="checkbox" name="remember"
                                    class="h-4 w-4 rounded border-slate-300 text-sky-600 focus:ring-2 focus:ring-sky-500/30">
                                Ingat saya
                            </label>

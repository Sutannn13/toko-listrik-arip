...
@section('content')
    ...
    <p class="mb-2 text-xs font-medium text-gray-500 sm:hidden">Geser tabel ke samping untuk melihat seluruh kolom.</p>
                        ...
                        <tr class="border-b border-gray-200 align-top hover:bg-gray-50">
                            <td class="p-4">
                                @if ($notification->read_at)
                                    <span
                                        class="inline-flex rounded bg-gray-100 px-2 py-1 text-xs font-semibold text-gray-600">
                                        Dibaca
                                    </span>
                                @else
                                    <span
                                        class="inline-flex rounded bg-cyan-100 px-2 py-1 text-xs font-semibold text-cyan-700">
                                        Baru
                                    </span>
                                @endif
                            </td>

        ...
        <div data-auth-grid class="grid w-full items-stretch gap-6 lg:grid-cols-[1.12fr,0.88fr] lg:gap-10">
            <section
                ...
                <div>
                    ...
                    <div class="mt-10 max-w-xl">
                        ...
                        <p class="mt-4 text-base leading-relaxed text-emerald-50">
                            Masuk untuk memantau transaksi, mengelola pesanan, dan memproses garansi dalam satu dashboard yang profesional dan mudah digunakan.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div class="rounded-2xl border border-white/30 bg-white/18 p-4">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-100">Tracking Real-time</p>
            ...
            <section class="w-full max-w-md place-self-center">
                ...
                <div data-auth-card class="rounded-3xl border border-white/90 bg-white/96 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.35)] backdrop-blur-md sm:p-8">
                    <div>
                        ...
                        <h2 data-auth-title class="mt-2 text-[1.9rem] font-extrabold leading-tight text-slate-900">Selamat datang kembali</h2>
                        <p data-auth-subtitle class="mt-2 text-sm leading-relaxed text-slate-500">Silakan login untuk melanjutkan aktivitas belanja dan layanan purna jual Anda.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-6 space-y-5" data-ui-form data-auth-form>
                        @csrf
                        ...
                        <div class="flex items-center justify-between gap-3 text-sm">
                            <label for="remember_me" class="inline-flex cursor-pointer items-center gap-2 text-slate-600 select-none">

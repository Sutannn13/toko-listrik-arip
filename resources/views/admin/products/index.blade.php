            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-200 transform"
                ...
                <form :action="`{{ url('admin/products') }}/${productId}/adjust-stock`" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <button type="submit"
                            class="rounded-xl py-2.5 text-sm font-bold text-white shadow-sm transition"
                            :class="action === 'add' ? 'bg-success-500 hover:bg-success-600 shadow-success-500/20' : 'bg-error-500 hover:bg-error-600 shadow-error-500/20'">
                            Simpan
                        </button>
                    </div>
                </form>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="border-b border-gray-200 bg-gray-50 dark:border-dark-border dark:bg-dark-hover">
                        <th class="px-5 py-3.5 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Produk</th>
                        <th class="px-5 py-3.5 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Kategori</th>
                        <th class="px-5 py-3.5 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Harga</th>
                        <th class="px-5 py-3.5 text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">Stok</th>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-dark-border">
                    @forelse($products as $product)
                        <tr class="group transition hover:bg-gray-50/50 dark:hover:bg-dark-hover/50">
                            ...
                            <td class="px-5 py-4">
                                <span class="inline-flex rounded-full bg-gray-100 px-2.5 py-1 text-xs font-semibold text-gray-700 dark:bg-dark-hover dark:text-gray-300">
                            ...
                            <td class="px-5 py-4">
                                <div class="flex items-center gap-2">
                                    <span class="inline-flex min-w-[32px] items-center justify-center rounded-lg px-2.5 py-1 text-sm font-bold
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-5 py-12 text-center">
                                ...
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Belum ada produk ditambahkan.</p>
                                <a href="{{ route('admin.products.create') }}"

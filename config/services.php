...
return [
    ...
    */
    ...
    'ai' => [
        ...
        'estimated_cost_per_request_idr' => (int) env('AI_ESTIMATED_COST_PER_REQUEST_IDR', 350),
        ...
        'complex_case_enabled' => filter_var(env('AI_COMPLEX_CASE_ENABLED', true), FILTER_VALIDATE_BOOLEAN),
        'complex_case_high_threshold' => (int) env('AI_COMPLEX_CASE_HIGH_THRESHOLD', 65),
        'complex_case_critical_threshold' => (int) env('AI_COMPLEX_CASE_CRITICAL_THRESHOLD', 85),

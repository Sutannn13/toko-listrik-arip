            ...
            <section
                ...
                <div>
                    ...
                    <div class="mt-10 max-w-xl">
                        ...
                        <p class="mt-4 text-base leading-relaxed text-emerald-50">
                            Dengan satu akun, Anda dapat menyimpan alamat pengiriman, memantau transaksi, serta mengelola klaim garansi secara terstruktur.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="rounded-2xl border border-white/30 bg-white/18 p-4">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-100">Alamat Tersimpan</p>
                        <p class="mt-2 text-sm text-white">Lebih cepat saat checkout berikutnya, tanpa input berulang.</p>
                    </div>
                    <div class="rounded-2xl border border-white/30 bg-white/18 p-4">
                    ...
                    <div class="rounded-2xl border border-white/30 bg-white/18 p-4">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-100">Garansi Terintegrasi</p>
                        <p class="mt-2 text-sm text-white">Pengajuan klaim lebih jelas dengan jejak aktivitas lengkap.</p>
                    </div>
                    <div class="rounded-2xl border border-white/30 bg-white/18 p-4">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-100">Notifikasi Penting</p>
            ...
            <section class="w-full max-w-md place-self-center">
                ...
                <div data-auth-card class="rounded-3xl border border-white/90 bg-white/96 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.35)] backdrop-blur-md sm:p-8">
                    <div>
                        ...
                        <h2 data-auth-title class="mt-2 text-[1.9rem] font-extrabold leading-tight text-slate-900">Buat akun baru</h2>
                        <p data-auth-subtitle class="mt-2 text-sm leading-relaxed text-slate-500">Lengkapi data berikut untuk mulai belanja dengan proses checkout yang lebih nyaman.</p>
                    </div>

                    <form method="POST" action="{{ route('register') }}" class="mt-6 space-y-5" data-ui-form data-auth-form>
                        @csrf

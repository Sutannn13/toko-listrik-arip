...
@auth
    ...
    {{-- Single x-data wrapper to coordinate notification + account dropdown states --}}
    <div x-data="{
        ...
        openNotification() {
            ...
            if (this.notificationOpen) {
                window.dispatchEvent(new CustomEvent('header-panel-opened'));
            }
        },
        openDropdown() {
        ...
        x-on:chat-panel-opened.window="closeAll()"
        ...
        @if (!$isAdminUser)
            ...
            <div class="relative hidden lg:block">
                <button x-on:click="openNotification()"
                ...
                <div x-cloak x-show="notificationOpen" x-on:click.away="notificationOpen = false"
                    ...
                    class="absolute right-0 z-[80] mt-2 w-80 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl shadow-gray-200/70">
        ...
        {{-- Account dropdown --}}
        <div class="relative">
            <button x-on:click="openDropdown()"
            ...
            <div x-cloak x-show="dropdownOpen" x-on:click.away="dropdownOpen = false" x-transition:enter="ease-out duration-150"
                ...
                class="absolute right-0 z-[80] mt-2 w-64 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl shadow-gray-200/70">

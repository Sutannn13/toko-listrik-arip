...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4 text-center">
    @php
        $storePhoneRaw = (string) \App\Models\Setting::get('store_phone', '085718021362');
        ...
        $maintenanceWhatsapp = $storePhoneDigits !== '' ? $storePhoneDigits : '6285718021362';
    @endphp
    ...
    <div class="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
        ...
        <a href="https://wa.me/{{ $maintenanceWhatsapp }}" target="_blank"
        ...
        @if (\Illuminate\Support\Facades\Auth::check() && \Illuminate\Support\Facades\Auth::user()->hasRole('super-admin|admin'))
            <div class="mt-8 pt-6 border-t border-gray-100">
                ...
                <a href="{{ route('admin.dashboard') }}"
                    class="text-sm font-semibold text-blue-600 hover:underline">Masuk ke Dashboard</a>
            </div>
        @endif
    </div>
</body>

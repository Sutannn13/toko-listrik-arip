...
@section('content')
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-dark-border dark:bg-dark-card max-w-4xl">
        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                {{-- Deskripsi --}}
                <div class="md:col-span-2">
                    <label class="mb-1.5 block text-sm font-semibold text-gray-700 dark:text-gray-300">Deskripsi / Spesifikasi</label>
                ...
                <div class="md:col-span-2 grid sm:grid-cols-2 gap-4">
                    <label class="flex cursor-pointer items-start gap-3 rounded-xl border border-blue-100 bg-blue-50 p-4 dark:border-blue-500/20 dark:bg-blue-500/10">
                        ...
                        <span>
                            ...
                            <span class="text-xs text-gray-500 dark:text-gray-400">Aktifkan untuk mengizinkan klaim garansi (maks. 7 hari).</span>
                        </span>
                    </label>

                    <label class="flex cursor-pointer items-start gap-3 rounded-xl border border-green-100 bg-green-50 p-4 dark:border-green-500/20 dark:bg-green-500/10">
                        ...
                        <span>
                            ...
                            <span class="text-xs text-gray-500 dark:text-gray-400">Nonaktifkan untuk menyembunyikan dari katalog.</span>
                        </span>
                    </label>
                </div>
            </div>

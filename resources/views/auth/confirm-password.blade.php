            ...
            <section
                ...
                <div>
                    ...
                    <div class="mt-10 max-w-xl">
                        ...
                        <p class="mt-4 text-base leading-relaxed text-emerald-50/95">
                            Untuk keamanan, sistem meminta konfirmasi password Anda sebelum membuka fitur yang bersifat
                            sensitif.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="rounded-2xl border border-white/20 bg-white/12 p-4 sm:col-span-2">
                        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-100">Keamanan Berlapis
                        </p>
                        <p class="mt-2 text-sm text-white/90">Langkah ini membantu melindungi akun Anda dari akses yang
                            tidak sah.</p>
                    </div>
                ...
                <div data-auth-card
                    ...
                    <div>
                        ...
                        <h2 data-auth-title class="mt-2 text-[1.9rem] font-extrabold leading-tight text-slate-900">
                            Konfirmasi password</h2>
                        <p data-auth-subtitle class="mt-2 text-sm leading-relaxed text-slate-500">Masukkan password akun
                            Anda untuk melanjutkan ke halaman berikutnya.</p>
                    </div>

                    <form method="POST" action="{{ route('password.confirm') }}" class="mt-6 space-y-5" data-ui-form
                        data-auth-form>
                        @csrf

    ...
    <div class="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-10">
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        <li>
                            <a href="{{ route('home') }}" class="text-slate-400 transition hover:text-brand-300">Katalog</a>
                        </li>
                        <li>
                            <a href="{{ route('home.tracking') }}" class="text-slate-400 transition hover:text-brand-300">Lacak Pesanan</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        ...
                        <li>
                            <a href="{{ $emailUrl }}" class="text-slate-400 transition hover:text-brand-300">Email</a>
                        </li>
                        <li>
                            <a href="{{ $mapsUrl }}" target="_blank" rel="noopener noreferrer"
                                class="text-slate-400 transition hover:text-brand-300">Google Maps</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        <li>
                            <a href="{{ route('legal.privacy') }}" class="text-slate-400 transition hover:text-brand-300">Privacy Policy</a>
                        </li>
                        <li>
                            <a href="{{ route('legal.terms') }}" class="text-slate-400 transition hover:text-brand-300">Terms & Conditions</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="mt-4 flex gap-5 sm:mt-0 sm:justify-center">
                <a href="{{ $whatsAppUrl }}" target="_blank" rel="noopener noreferrer" class="text-slate-400 transition hover:text-brand-300" aria-label="WhatsApp">
                ...
                <a href="{{ $emailUrl }}" class="text-slate-400 transition hover:text-brand-300" aria-label="Email">
                    <svg class="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm0 3.25-8 5-8-5V6l8 5 8-5v1.25z" />
                    </svg>
                </a>
                <a href="{{ $mapsUrl }}" target="_blank" rel="noopener noreferrer" class="text-slate-400 transition hover:text-brand-300" aria-label="Google Maps">
                    <svg class="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                        <path

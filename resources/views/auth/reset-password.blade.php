    ...
    <main class="relative z-10 flex min-h-screen items-center justify-center px-4 py-8">
        <div class="w-full max-w-md">
            ...
            <div class="mb-8 text-center">
                <a href="{{ route('home') }}" class="inline-flex items-center gap-3">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-xs font-medium text-white/70">Pembaruan kredensial akun</p>
                    </div>
                </a>
            </div>
            ...
            <div class="rounded-2xl border border-gray-200/80 bg-white p-7 shadow-2xl sm:p-9">
                <div class="mb-6">
                    {{-- Shield Check Icon --}}
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-green-50">
                    ...
                    <h1 class="text-2xl font-extrabold text-gray-900">Atur Ulang Password</h1>
                    <p class="mt-2 text-sm leading-relaxed text-gray-500">
                        Masukkan password baru Anda, lalu konfirmasi untuk menyelesaikan proses pemulihan akun.
                    </p>
                </div>

                <form method="POST" action="{{ route('password.store') }}" class="space-y-5" data-ui-form
                    data-auth-form>
                    @csrf
                    ...
                    {{-- Password Baru --}}
                    <div>
                        <label for="password" class="mb-1.5 block text-sm font-semibold text-gray-700">Password
                            Baru</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="password_confirmation"
                            class="mb-1.5 block text-sm font-semibold text-gray-700">Konfirmasi Password
                            Baru</label>
                        <div class="relative">

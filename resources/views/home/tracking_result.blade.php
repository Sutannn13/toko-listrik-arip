...
<body
    class="min-h-screen bg-gray-50 font-sans text-gray-800 antialiased selection:bg-primary-500 selection:text-white flex flex-col">
    ...
    <div class="relative z-10 flex-1 flex flex-col">
        ...
        <main class="mx-auto w-full max-w-4xl px-4 py-8 sm:px-6 lg:px-8 flex-1">
            ...
            @if (session('success'))
                <div
                    class="mb-6 rounded-xl border border-green-200 bg-green-50 p-4 flex gap-3 text-sm text-green-700 items-start">
                    <p>{{ session('success') }}</p>
                </div>
            @endif
            @if (session('error'))
                <div
                    class="mb-6 rounded-xl border border-red-200 bg-red-50 p-4 flex gap-3 text-sm text-red-700 items-start">
                    <p>{{ session('error') }}</p>
                </div>
            @endif
            ...
            @if ($order->status !== 'cancelled' && $order->payment_status !== 'paid')
                ...
                @elseif($latestPayment && $latestPayment->proof_url)
                    <div
                        class="mb-6 rounded-xl border border-blue-200 bg-blue-50 p-4 shadow-sm flex items-center gap-4">
            ...
            <div
                ...
                <div
                    ...
                    @if ($order->payment_status === 'paid')
                        <p class="text-sm font-bold text-green-700 flex items-center gap-1.5"><svg class="w-4 h-4"
            ...
            <div class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="lg:col-span-1 space-y-6">
                    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                        <h3
                            class="text-sm font-bold text-gray-900 border-b border-gray-100 pb-3 mb-4 uppercase tracking-wider">
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm filter flex flex-col h-full">
                        ...
                        <div class="space-y-4 flex-1">
                            @foreach ($order->items as $item)
                                <div
                                    class="flex justify-between items-start border-b border-gray-50 pb-4 last:border-0 last:pb-0">
                                    <div>
                        ...
                        <div class="mt-6 border-t border-gray-200 pt-4 space-y-2">
                            <div class="flex justify-between text-sm">
                                ...
                                <span
                                    class="font-bold text-gray-900">{{ number_format($order->items->sum('quantity')) }}</span>
                            </div>
